...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			if($total_sales > 1 ){
				$data['top_selling'] = '<div class="product-top-selling">Top Selling</div>';
			} else {
				$data['top_selling'] = "";
			}
			...
			$query_linked_categories = $this->model_catalog_product->getCategories($product_info['product_id']);
